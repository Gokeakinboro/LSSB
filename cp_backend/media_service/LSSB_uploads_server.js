...
BackxMediaService.init = function () {
    ...
    const server = Bun.serve({
        ...
        async fetch(req) {
            ...
            if (url.pathname.indexOf('/lssb_file') > - 1) {

                // const basePath = config.pages_dir; // config.pages_dir
                // let is_page = false;
                url.pathname = url.pathname.replace('//lssb_file/', '');
            ...
            if (url.pathname === '/upload') {
                ...
                try {
                    ...
                    // console.log(' >>>> formdata media_file -====>><<--->', media_file, 'https://static.lagosscholarship.org' + '/' + path );
                    ...
                    return new Response(
                        JSON.stringify({
                            ...
                            data: {
                                ...
                                files: ['https://static.lagosscholarship.org' + '/' + path],
                                file_name: _name
