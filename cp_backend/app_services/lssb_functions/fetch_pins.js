...
export let fetch_pins = async function (reqObj, model, helpers) {
    ...
    let capabilities_passed = false;
     ...
     if ( helpers.auth$.role == 'xSuperLSSBxAdmin' || ( helpers.auth$.ca && helpers.auth$.ca.indexOf('fetchPIN') > -1 ) ) {
    ...
    console.log(
        ...
        'Get PINs  --many -- db_response -===>', 'db_get_response',
        reqObj.payloadData, '\n $check res --->>',
        //  db_get_response.check_connection_resul
