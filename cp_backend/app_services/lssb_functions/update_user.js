...
export let update_user = async function (reqObj, model, helpers) {
    ...
    // delete reqObj.payloadData['_fields.lassra'];
    // delete reqObj.payloadData['lassra'];
    delete reqObj.payloadData['role'];
    // delete reqObj.payloadData['_fields.lasrra'];
    // delete reqObj.payloadData['lasrra'];
    // delete reqObj.payloadData.username;
    ...
    // console.log(' Updating User --- -----00---- Post  -===>', 'reqObj.payloadData', '\n ', update_post_res);
    ...
    if (update_post_res && update_post_res.msg == 'Docs not found') {
    ...
    if (update_post_res && update_post_res.msg !== 'OK') {
        ...
        return { success: false, statusCode: 400, error: { msg: update_post_res.msg } }
