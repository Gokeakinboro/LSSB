...
const allowed_roles = ['xSuperLSSBxAdmin', 'xLSBxAdmin', '$Sys9'];

export let fetch_admins = async function (reqObj, model, helpers) {
    ...
    if (reqObj.payloadData.$where && reqObj.payloadData.$where['_id'] == '$self') {
        ...
        if (!helpers.auth$._id) {
            ...
            return { error: { msg: 'Unauthorized Admin request' }, statusCode: 401, success: false };
            // }
    ...
    if (reqObj.payloadData.$where && reqObj.payloadData.$where._id) {
        ...
        //     'Get 1 Admin db_response -===>', 'db_get_response',
        //     reqObj.payloadData, '\n $check res --->>',
        //     //  db_get_response.check_connection_resul
        //     db_get_response
    ...
    console.log(
        ...
        'Get Admins db_response -===>', 'db_get_response',
        // reqObj.payloadData, '\n $check res --->>',
        //  db_get_response.check_connection_resul
