...
export let follow_unfollow_page = async function (reqObj, model, helpers) {
    ...
    if (the_action == 'follow') {
        ...
        acting_user_data['$connections$.following_count'] = { '$add': 1 };
        ...
        page_to_follow_data['$connections$.followers_count'] = { '$add': 1 };
