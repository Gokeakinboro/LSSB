...
const { create_application } = await import('../lssb_functions/create_application.js');

const { fetch_applications } = await import('../lssb_functions/fetch_applications.js');

const { update_application } = await import('../lssb_functions/update_application.js');
...
export let theController = async function (reqObj) {
    ...
    try {
        ...
        if (typeof controller_fncs[cloud_action] == 'function') {
            ...
            let cloud_response = await controller_fncs[cloud_action](reqObj, LSSB_applications_model, { LSSB_applicants_model, utils, Crypto, aNode, auth$ });
