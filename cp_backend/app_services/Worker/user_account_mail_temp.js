let user_account_mail_temp = function(data) {
...
-8 -4 -11 -10z" />
                ...
                <div class="mail_card_body px20" style="padding-left: 20px; padding-right: 20px; color: #585d6f;">
                    ...
                    <p style="color: #787878;"> You're receiving this email because you recently created an account at the Lagos State Scholarship Board's Portal </strong> </p>

                    <p style="color: #787878;"> To verify and gain access to your account, kindly verify your account with the OTP below. </p>

                    <!-- // btn -->
                    <div class="btn bg2" style="color: #e05656; background-color: rgb(250, 248, 244); display: -webkit-inline-box; display: -ms-inline-flexbox; display: inline-flex; -webkit-box-pack: center; -ms-flex-pack: center; justify-content: center; white-space: nowrap; line-height: initial; -webkit-user-select: none; -ms-user-select: none; user-select: none; text-decoration: none; outline: none; padding: .7rem 1rem .6rem; border-radius: 8px; margin-bottom: .7rem;">
...
0 50 -9 14 -21 25 -27 25 -5 0 -2 -9 8 -20z" />
                    ...
                    <p class="mbf" style="padding-bottom: 1.5em;">Kindly ignore this email if you didn't sign-up on the Portal. </p>
...
26 111 26 153 0z" />
    ...
    module.exports = user_account_mail_temp; 