let lssb_admin_welcome_mail_temp = function(data) {
...
-8 -4 -11 -10z" />
                    ...
                    <h2 style="font-size: 1.3rem; margin-top: 0; color: rgb(229, 226, 218);"> Staff Account Creation </h2>

                </header>
                <!-- // mail card header // -->

                <!-- // mail card body -->
                <div class="mail_card_body px20" style="padding-left: 20px; padding-right: 20px; color: #585d6f; padding-bottom: 20px;">

                    <p class="mbp" style="color: #333;">Hello, ${data.fullname} </p>

                    <p style="color: #787878;"> An account was recently created for you as a staff of the Lagos State Scholarship Board. <br> You'll be able to carry out your designated tasks once you log-in into the dashboard. </strong> </p>

                    <p style="color: #787878;"> click the link below to activate your account and access your dashobard: </p>
                    ...
                    <!-- <p style="color: #787878;"> Enter the OTP above to set your account password. </p> -->
                    <!-- // btn // -->
            ...
            <div class="footer_top d-flex c1"
                ...
                <div class="left">
                    ...
                    <a href="https://lagosscholarship.org/" class="lk"
                        style="color: inherit; text-decoration: none; font-size: .95rem; display: inline-block; margin: 0 5px;">Visit the LSSB website</a>

                    <span>|</span>

                    <a href="https://admin.lagosscholarship.org/" class="lk"
                        style="color: inherit; text-decoration: none; font-size: .95rem; display: inline-block; margin: 0 5px;">Admin Dashboard
                    </a>
                </div>
                <!-- // left // -->
...
26 111 26 153 0z" />
    ...
    module.exports = lssb_admin_welcome_mail_temp; 