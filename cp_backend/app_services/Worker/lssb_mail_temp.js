let lssb_mail_temp = function(data) {
...
-8 -4 -11 -10z" />
                    ...
                    <h2 style="font-size: 1.3rem; margin-top: 0; color: rgb(229, 226, 218);"> Password Reset Request </h2>
                ...
                <div class="mail_card_body px20" style="padding-left: 20px; padding-right: 20px; color: #585d6f;">
                    ...
                    <p class="mbp" style="color: #333;">Hello,</p>

                    <p style="color: #787878;">You requested to reset your password to the Lagos State Scholarship Board's Application Portal </strong> </p>

                    <p style="color: #787878;"> Use this OTP to approve and complete your request. </p>

                    <!-- // btn -->
                    <div class="btn bg2"
                        style="color: #e05656; background-color: rgb(250, 248, 244); display: -webkit-inline-box; display: -ms-inline-flexbox; display: inline-flex; -webkit-box-pack: center; -ms-flex-pack: center; justify-content: center; white-space: nowrap; line-height: initial; -webkit-user-select: none; -ms-user-select: none; user-select: none; text-decoration: none; outline: none; padding: .7rem 1rem .6rem; border-radius: 8px; margin-bottom: .7rem;">

                        ${data.otp}

                        <span class="box_x d_none" style="color: inherit; width: 1.2rem; margin-left: 6px;">

                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 23.000000 22.000000"
                                preserveaspectratio="xMidYMid meet" style="color: #fff; fill: #fff;">

                                <g transform="translate(0.000000,22.000000) scale(0.100000,-0.100000)" stroke="none">
                                    <path d="M48 191 c-29 -26 -33 -35 -33 -81 0 -46 4 -55 33 -81 44 -39 90 -39
134 0 29 26 33 35 33 81 0 46 -4 55 -33 81 -22 20 -43 29 -67 29 -24 0 -45 -9
-67 -29z m111 5 c67 -35 65 -143 -4 -174 -33 -15 -47 -15 -80 0 -69 31 -71
137 -4 174 31 17 54 17 88 0z" />
                                    <path d="M125 140 c18 -20 17 -20 -28 -20 -26 0 -47 -4 -47 -10 0 -5 21 -10
47 -10 45 0 46 0 28 -20 -10 -11 -13 -20 -8 -20 6 0 18 11 27 25 15 23 15 27
0 50 -9 14 -21 25 -27 25 -5 0 -2 -9 8 -20z" />
                                </g>
                            </svg>
                    ...
                    <p class="mbf" style="padding-bottom: 1.5em;">Kindly ignore this email if you didn't initiate this request. </p>
...
26 111 26 153 0z" />
            ...
            <div class="footer_ d-flex c3 fssm"
                ...
                <div class="left">
                    ...
                    <a href="#" style="color: inherit; text-decoration: none;">&copy; 2023 Lagos State Scholarship Board | All rights
                        reserved </a>
                </div>
                <!-- // left // -->
